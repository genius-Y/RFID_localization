...
subplot(2,2,1),plot(t,z,'g',t,x_hat(:,1),'r')
xlabel('time (s)'),title('Position x_1'),grid
legend('z=x_1','x_1hat')

subplot(2,2,2),plot(t,x(:,2),'g',t,x_hat(:,2),'r')
xlabel('time (s)'),title('Velocity x_2'),grid
legend('x_2','x_2hat')

subplot(2,2,3),plot(t,eps),xlabel('time (s)'),title('Estimation error: z - zhat'),grid
subplot(2,2,4),plot(t,X_hat),xlabel('time (s)'),title('Diagonal of covariance matrix X'),grid
