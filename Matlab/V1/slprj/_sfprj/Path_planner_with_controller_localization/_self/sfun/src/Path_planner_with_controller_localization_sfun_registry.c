...
{
  extern unsigned int
    sf_Path_planner_with_controller_localization_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Path_planner_with_controller_localization_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_Path_planner_with_controller_localization_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "Path_planner_with_controller_localization") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Path_planner_with_controller_localization_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Path_planner_with_controller_localization_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Path_planner_with_controller_localization") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Path_planner_with_controller_localization_third_party_uses_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Path_planner_with_controller_localization_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Path_planner_with_controller_localization") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Path_planner_with_controller_localization_jit_fallback_info(nlhs,
      plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "Path_planner_with_controller_localization") == 0) {
    ...
    newRhs[2] = prhs[3];
    return
      sf_Path_planner_with_controller_localization_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int
  sf_Path_planner_with_controller_localization_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Path_planner_with_controller_localization")) {
    return(sf_Path_planner_with_controller_localization_method_dispatcher
...
extern void Path_planner_with_controller_localization_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Path_planner_with_controller_localization_terminator();
...
extern void Path_planner_with_controller_localization_initializer(void);
extern void Path_planner_with_controller_localization_register_exported_symbols
  (SimStruct* S);
extern void Path_planner_with_controller_localization_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Path_planner_with_controller_localization_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Path_planner_with_controller_localization_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    Path_planner_with_controller_localization_initializer();
  }
