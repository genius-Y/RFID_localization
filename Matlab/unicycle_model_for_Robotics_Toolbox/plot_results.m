...
figure(2)
subplot(1,2,1)
plot(xd(t0:t01),yd(t0:t01),'r--',x(t0:t1),y(t0:t1),'b-');
axis([-2 2 -2.5 0.5]);
legend('Reference','Actual');
title('Before Parameter Updating');
xlabel('x [m]');
ylabel('y [m]');
grid on
subplot(1,2,2)
plot(xd(t0:t01),yd(t0:t01),'r--',x(t22:t3),y(t22:t3),'b-');
axis([-2 2 -2.5 0.5]);
legend('Reference','Actual');
title('After Parameter Updating');
xlabel('x [m]');
ylabel('y [m]');
grid on
