model_script_Cascade
sim Cascade_controller
close all;
%% Figures
pt = 10;
sizeX = 12;
...
axis([0 20 -.1 2]);
leg = legend('Sensor','Estimate','Real', 'Reference');
...
hold off
box off
% print(hfig,'Figures/casc_pos','-depsc')
...
hold off
box off
% print(hfig,'Figures/casc_vel','-depsc')
...
hold off
box off
% print(hfig,'Figures/casc_ang','-depsc')
...
hold off
box off
% print(hfig,'Figures/casc_angv','-depsc')
...
axis([0 20 -.2 1.3]);
xlabel('Time $t$ (s)','FontUnits','points','interpreter','latex','FontSize',pt);
ylabel('Roll ref. $\phi_{ref}$ (rad)','FontUnits','points','interpreter','latex','FontSize',pt);
% axis([0 20 -.2 1]);
% leg = legend('$\tau_{\phi}$','$\tau_{\theta}$','$\tau_{\psi}$');
% set(leg,'Location','best','Interpreter','latex','FontSize',pt);
set(gca,'TickLabelInterpreter','latex')
...
pos = get(hfig,'position');set(hfig,'position',[pos(1:2),sizeX,sizeY]);
subplot(2,1,2)
plot(t,angle_ref(:,1));grid;
axis([0 20 -1.7 .2]);
box off
xlabel('Time $t$ (s)','FontUnits','points','interpreter','latex','FontSize',pt);
ylabel('Pitch ref. $\theta_{ref}$ (rad)','FontUnits','points','interpreter','latex','FontSize',pt);
hold off
box off
% print(hfig,'Figures/casc_angv','-depsc')